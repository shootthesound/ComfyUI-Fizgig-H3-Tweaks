...
| **Detail mode** | stable across frames | *stable*: only detail that is the same in every frame (measured +7% shimmer at 0.3); *per frame*: each frame's own (+20% shimmer on clips — fine for stills). |
